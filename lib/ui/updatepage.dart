...
class _MyUpdatePageState extends State<MyUpdatePage> {
  ...
  Future getPosts() async {
    ...
    QuerySnapshot qn = await firestore.collection("ejercicios").getDocuments();
    // print();
    return qn.documents;
  }
            ...
            children: <Widget>[
              RaisedButton(
                ...
                onPressed: () {
                  ...
                  var part1 =
                      'https://firebasestorage.googleapis.com/v0/b/gymtastic-b8d89.appspot.com/o/'; //esto cambia segun su firestore
