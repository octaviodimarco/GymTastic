...
class _MyAddPageState extends State<MyAddPage> {
  ...
  void createData() async {
    ...
    var part1 =
        'https://firebasestorage.googleapis.com/v0/b/gymtastic-b8d89.appspot.com/o/';
    ...
    if (_formKey.currentState.validate()) {
      ...
      DocumentReference ref = await db.collection('ejercicios').add(
          {'name': '$name', 'description': '$description', 'image': '$fullPathImage'});
