...
void main() => runApp(MaterialApp(
    home: SafeArea(child: Scaffold(body: Material(child: HorarioMartes())))));
...
class HorarioMartes extends StatefulWidget {
  _HorarioMartes createState() => _HorarioMartes();
}

class _HorarioMartes extends State<HorarioMartes> {
 ...
 |_____\___/|_| \_|_____|____/                               
    ...
    */
    ...
    return Container(
      ...
      child: SimpleFoldingCell(
          key: _foldingCellKey,
          frontWidget: buildFrontWidgetMartes(),
          innerTopWidget: _buildInnerTopWidgetMartes(),
          innerBottomWidget: _buildInnerBottomWidgetMartes(),
  ...
  Widget _buildInnerTopWidgetMartes() {
    return Container(
      color: Color(0xffDEDEE5),
      child: ListView(
  ...
  Widget _buildInnerBottomWidgetMartes() {
    return Container(
        color: Color(0xffDEDEE5),
        alignment: Alignment.bottomCenter,
        child: ListView(
