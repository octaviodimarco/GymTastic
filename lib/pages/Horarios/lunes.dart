...
void main() => runApp(MaterialApp(
    home: SafeArea(child: Scaffold(body: Material(child: HorarioLunes())))));
...
class HorarioLunes extends StatefulWidget {
  _HorarioLunes createState() => _HorarioLunes();
}

class _HorarioLunes extends State<HorarioLunes> {
 ...
 |_____\___/|_| \_|_____|____/                               
    ...
    */
    ...
    return Container(
      ...
      child: SimpleFoldingCell(
          key: _foldingCellKey,
          frontWidget: buildFrontWidgetLunes(),
          innerTopWidget: _buildInnerTopWidgetLunes(),
          innerBottomWidget: _buildInnerBottomWidgetLunes(),
  ...
  Widget _buildInnerTopWidgetLunes() {
    return Container(
      color: Color(0xffDEDEE5),
      child: ListView(
  ...
  Widget _buildInnerBottomWidgetLunes() {
    return Container(
        color: Color(0xffDEDEE5),
        alignment: Alignment.bottomCenter,
        child: ListView(
