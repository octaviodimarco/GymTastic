...
void main() => runApp(MaterialApp(
    home: SafeArea(child: Scaffold(body: Material(child: HorarioViernes())))));
...
class HorarioViernes extends StatefulWidget {
  _HorarioViernes createState() => _HorarioViernes();
}

class _HorarioViernes extends State<HorarioViernes> {
 ...
 |_____\___/|_| \_|_____|____/                               
    ...
    */
    ...
    return Container(
      ...
      child: SimpleFoldingCell(
          key: _foldingCellKey,
          frontWidget: buildFrontWidgetViernes(),
          innerTopWidget: _buildInnerTopWidgetViernes(),
          innerBottomWidget: _buildInnerBottomWidgetViernes(),
  ...
  Widget buildFrontWidgetViernes() {
    return Container(
      color: Colors.white,
  ...
  Widget _buildInnerTopWidgetViernes() {
    return Container(
      color: Color(0xffDEDEE5),
      child: ListView(
  ...
  Widget _buildInnerBottomWidgetViernes() {
    return Container(
        color: Color(0xffDEDEE5),
        alignment: Alignment.bottomCenter,
        child: ListView(
