...
void main() => runApp(MaterialApp(
    home: SafeArea(child: Scaffold(body: Material(child: HorarioJueves())))));
...
class HorarioJueves extends StatefulWidget {
  _HorarioJueves createState() => _HorarioJueves();
}

class _HorarioJueves extends State<HorarioJueves> {
 ...
 |_____\___/|_| \_|_____|____/                               
    ...
    */
    ...
    return Container(
      ...
      child: SimpleFoldingCell(
          key: _foldingCellKey,
          frontWidget: buildFrontWidgetJueves(),
          innerTopWidget: _buildInnerTopWidgetJueves(),
          innerBottomWidget: _buildInnerBottomWidgetJueves(),
  ...
  Widget _buildInnerTopWidgetJueves() {
    return Container(
      color: Color(0xffDEDEE5),
      child: ListView(
  ...
  Widget _buildInnerBottomWidgetJueves() {
    return Container(
        color: Color(0xffDEDEE5),
        alignment: Alignment.bottomCenter,
        child: ListView(
